...
- Drei relevante Zeitfenster:
  ...
  - Rückweg (Velo): 17:30–18:00 → Stunden 17–18
...
- API: Open-Meteo `/v1/forecast` mit `hourly=apparent_temperature,precipitation_probability,precipitation`, `forecast_days=1`, `timezone=auto`
